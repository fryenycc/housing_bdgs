...
-- How long do these buildings tend to stay in AEP
```{r echo=FALSE}
summary(aep$Duration)
```

-- How many buildings go through AEP more than once?
-- What is the distribution of the duration in AEP for buildings? 
```{r echo=FALSE}
